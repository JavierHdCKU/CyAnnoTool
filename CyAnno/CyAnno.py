...
##### Mandatory ######
handgatedFileinfo='/home/javier/scina_module/test_data/Handgated.csv' 		## [Mandatory] hand-gated cells to be used for training
LiveFileinfo= '/home/javier/scina_module/test_data/LivecellsTraining.csv'    	## [Mandatory] All Live cells of the samples used for handgating (i.e. training); these samples will also be labelled
unlabelledDataset= '/home/javier/scina_module/test_data/Livecells.csv'    		## [Mandatory] All Live cells to be tested for annotation, i.e. for cell type identification
relevantMarkers = ["FSC-A","SSC-A","FITC-A","Pacific Blue-A","AmCyan-A","Qdot 605-A","APC-A","Alexa Fluor 700-A"] 	## [Mandatory] lineage markers used for hand-gated; based on column names in FCS/CSV file  
outdir = 'FlowSOM_Results' 					##  Mandatory when loadModel=False] any name of choice. If directory will hold saved session and labelled CSV file.	
